            ...
            <v-card>
              <v-container>
                <v-form @submit.prevent="addEvent">
                  ...
                  <v-text-field type="datetime-local" label="Inicio del evento" v-model="start"></v-text-field>
                  <v-text-field type="datetime-local" label="Termino del evento" v-model="end"></v-text-field>
