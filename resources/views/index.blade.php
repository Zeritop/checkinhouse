...
<div id="cajaTextoHome">
  ...
  <div id="botonHome">
    <span><a href="{{url('serviciosss')}}" id="aBtnHome">Agenda aquí</a></span>
  </div>
    ...
    <div class="container text-center">
        ...
        <div class="row mt-3">
            ...
            <div class="card card-profile border-success" style="border: solid 3px;">
              ...
              <div class="card-body ">
                    ...
                    <p class="card-description">
                      Trabajamos en los horarios que a usted más le acomoden, para no parar su vehículo en ningún momento.
                    </p>
         ...
         <!-- <div class="row col-md-3 offset-md-1" style="border: 2px solid #000;">
            ...
            <p>Trabajamos en los horarios que a usted más le acomoden, para no parar su vehículo en ningún momento.</p>
          </div> -->
         ...
         <!-- <div class="row col-md-3 offset-md-1">
            ...
            <p>Usted conocerá el detalle de las intervenciones en su vehículo, así como de los diagnósticos y recomendaciones que tenemos para usted.</p>
          </div> -->
          ...
          <div class="col-md-4">
            <div class="card card-profile border-warning" style="border: solid 3px;">
              ...
              <div class="card-body ">
                    ...
                    <h4 class="card-title">Ahorre tiempo y extienda la vida útil de sus equipos</h4>

                    <p class="card-description">
                      Nuestra principal preocupación es generar la menor pérdida de tiempo y la mayor durabilidad de su vehículo.
                    </p>
