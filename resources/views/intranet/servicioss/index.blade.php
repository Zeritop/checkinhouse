...
<div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ route('servicioss.create') }}"> Crear Nuevo Aceite</a>
            </div>
        </div>
        <div class="pull-right">
  ...
  if (x)
    ...
    return false;
        ...
        <td>
            <a class="btn btn-info" href="{{ route('servicioss.show',$servicio->id) }}">Ver</a>
            <a class="btn btn-primary" href="{{ route('servicioss.edit',$servicio->id) }}">Editar</a>
